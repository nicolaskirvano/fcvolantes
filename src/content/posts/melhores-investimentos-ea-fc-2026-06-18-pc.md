...
title: "Momentum de Volantes no EA FC em 18/06 — PC"
draft: false
featured: true
tags:
  - investimentos
  ...
  - previsoes
  - pc
description: "Ranking histórico de momentum em 18/06/2026 no PC: Adam Wharton liderou 7d com +77,2%. Compare preços, 24h/7d, gráfico e limites."
---
...
**Adam Wharton** liderou o recorte com **+77,2% em 7d** e +40,0% em 24h. Entre 15 cartas, 15 tinham as duas janelas positivas; a mediana semanal foi **+39,5%**.

Os preços destacados iam de **23k coins** a **198k coins**. O ranking descreve momentum observado naquela data; previsão ausente ou inválida aparece como N/D e não confirma uma compra atual.

![Gráfico de variação em 7 dias para os destaques de Momentum de Volantes no EA FC em 18/06 — PC](/charts/melhores-investimentos-ea-fc-2026-06-18-pc.svg)
...
- **Denise O'Sullivan (85)** — 26k coins, **+56.9% em 7 dias** (+30.8% em 24h). Preço +14% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
- **Esteban Cambiasso (86)** — 23k coins, **+50.8% em 7 dias** (+39.4% em 24h). Preço +37% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Sofie Junge Pedersen (86)** — 25k coins, **+50.7% em 7 dias** (+35.1% em 24h). Preço +9% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
Adam Wharton (88, Premier League) lidera, com +77.2% em 7 dias a 35k coins no PC. No recorte, isso descrevia momentum observado, não uma recomendação atual.
...
- [Volantes no EA FC em 18/06: altas e baixas — PC](/posts/mercado-ea-fc-2026-06-18-pc/)
