...
title: "Volantes no EA FC em 02/06: altas e baixas — PS"
draft: false
featured: true
tags:
  - mercado
  ...
  - altas-e-baixas
  - ps
description: "Snapshot histórico de 02/06/2026 no PS: Adam Wharton liderou as altas e Felix Nmecha as baixas em Volantes. Compare preços, variações, gráfico e riscos."
---
...
Nas 20 cartas destacadas nas tabelas, **Adam Wharton** registrou o maior movimento de 24h (+52,6%), enquanto **Felix Nmecha** marcou o menor (-37,5%). A distância entre os extremos foi de **90,1 pontos percentuais**.
...
![Gráfico de variação em 24h para os destaques de Volantes no EA FC em 02/06: altas e baixas — PS](/charts/mercado-ea-fc-2026-06-02-ps.svg)
...
- **Wouter Burger (87)** caiu **-30.9%** em 24h, a **262k coins** (faixa do dia: 215k–390k). Está +34% acima da média de 7 dias (aquecida). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
No snapshot histórico, Declan Rice (91) — 95% de probabilidade de alta, a 220k coins.

**Como estava o mercado do EA FC nesse dia?**
Naquele dia, o mercado estava lateral — sem direção clara, com 60 cartas em alta contra 74 em queda (média 0.82%).
...
- [Momentum de Volantes no EA FC em 02/06 — PS](/posts/melhores-investimentos-ea-fc-2026-06-02-ps/)
